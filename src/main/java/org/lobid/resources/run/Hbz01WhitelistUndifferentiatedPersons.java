...
/**
 * Filter hbz01 to only take a dedicated list of resources into account,
...
public class Hbz01WhitelistUndifferentiatedPersons {
	...
	public static final String CONTEXT_URI =
			"http://lobid.org/resources/context.jsonld";
	static RdfGraphToJsonLd rdfGraphToJsonLd =
			new RdfGraphToJsonLd(CONTEXT_URI);
	...
	public static void main(String... args) {
		...
		if (args.length < 6) {
			System.err
					.println("Usage: MabXml2lobidJsonEs" + String.format(usage,
							" ", " ", " ", " ", " ", " ", " ", " ", " "));
			return;
		}
		...
		rdfGraphToJsonLd.setContextLocationFilname(System
				.getProperty("contextFilename", "web/conf/context.jsonld"));
		...
		System.out.println(
				"using jsonLdContextUri: " + rdfGraphToJsonLd.getContextUri());
	...
	private static ElasticsearchIndexer getElasticsearchIndexer() {
		...
		System.out.println(
				"lookupMabxmlDeletion: " + esIndexer.lookupMabxmlDeletion);
